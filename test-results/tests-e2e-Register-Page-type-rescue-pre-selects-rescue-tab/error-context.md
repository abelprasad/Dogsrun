...
- Name: tests\e2e.spec.ts >> Register Page >> ?type=rescue pre-selects rescue tab
...
Locator:  locator('button:text("Rescue")').first()
Expected: "rgb(245, 158, 11)"
Received: "rgb(244, 185, 66)"
Timeout:  5000ms

Call log:
  - Expect "toHaveCSS" with timeout 5000ms
  - waiting for locator('button:text("Rescue")').first()
    9 × locator resolved to <button type="button" class="flex-1 py-3 text-sm font-black uppercase tracking-[0.16em] transition-colors bg-[#f4b942] text-[#13241d]">rescue</button>
      - unexpected value "rgb(244, 185, 66)"
          ...
          - generic [ref=e27]:
            ...
            - generic [ref=e31]:
              - generic [ref=e32]:
                ...
                - textbox "Golden Retriever Rescue" [ref=e34]
              - generic [ref=e35]:
                - generic [ref=e36]:
              ...
              - button "Register as Rescue" [ref=e55]
          - paragraph [ref=e56]:
