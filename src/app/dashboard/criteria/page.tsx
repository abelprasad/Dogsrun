    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#fffbeb] border-b border-gray-200 py-12 px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-[900] tracking-tight text-[#111] mb-2">Matching criteria</h1>
      ...
      <main className="max-w-4xl mx-auto py-8 px-8">
        ...
        {!criteria && (
          <p className="mt-8 text-center text-xs text-[#9ca3af] uppercase tracking-widest font-bold">
            Need help? Contact <Link href="mailto:admin@dogsrun.org" className="text-[#f59e0b] hover:underline">admin@dogsrun.org</Link>
          </p>
        )}
      </main>
    </div>
