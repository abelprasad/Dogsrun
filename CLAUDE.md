...
This file stays intentionally short. Deeper project history, known bugs/gotchas, and the data source integration plan aren't tracked in-repo yet — ask the project owner if you need that context.
